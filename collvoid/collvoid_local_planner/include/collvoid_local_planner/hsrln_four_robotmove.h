...
//-----------------------------------------------------------------------------
//	Note:   Interaction 6机器人ORCA运动--基础程序--头文件
//-----------------------------------------------------------------------------
...
// //x向--6--机器人编号  y向--6
// //int idsi_data[6][6];
// float idsi_data[4][4];//根据需要改为float

// //机器人激光雷达探测长度数据：40个值，从正前方顺时针开始数？？
// float lidar_legth[4][40];//原为40测试中--机器人数量应为6个
...
// //订阅者--用于IDSI_Rank数据发布--回调函数--230702
...
// ros::Subscriber scan_sub_3;
// ros::Subscriber scan_sub_4;
// ros::Subscriber scan_sub_5;


// //订阅IDSI_Rank数据--230702
// ros::Subscriber IDSI_Rank[4];

//仿照写一个发布者？
//还有待细细调整-------------------------------------------------------------------------
ros::Publisher sac_cmd_vel_pub_[4];
// ros::Publisher sac_cmd_vel_pub_2;
// ros::Publisher sac_cmd_vel_pub_3;
// ros::Publisher sac_cmd_vel_pub_4;
// ros::Publisher sac_cmd_vel_pub_5;

//仿照写一个发布者？
//还有待细细调整-------------------------------------------------------------------------
ros::Publisher set_model_pub_[4];
// ros::Publisher set_model_pub_2;
// ros::Publisher set_model_pub_3;
// ros::Publisher set_model_pub_4;
// ros::Publisher set_model_pub_5;
